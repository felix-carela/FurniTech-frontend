...
function Header() {
  return (
    <div className='header-container'>
      ...
      <h3><NavLink to="/cart"><svg className='header-cart-svg'viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9 7H6.92013C6.40004 7 5.96678 7.39866 5.92359 7.91695L5.09025 17.917C5.04167 18.5 5.50176 19 6.0868 19H17.9132C18.4982 19 18.9583 18.5 18.9097 17.917L18.0764 7.91695C18.0332 7.39866 17.6 7 17.0799 7H15M9 7V5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7M9 7H15" stroke="#ffffff" strokeWidth="2" strokeLinejoin="round"></path> </g></svg></NavLink></h3>
      </div>
    </div>
  )
}
